"""Regression checks for the amber-svc-router-gate casebook."""
...
from casebook.harness import assert_expected, amber_svc_router_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_svc_router_gate_summary(), assert_expected())
